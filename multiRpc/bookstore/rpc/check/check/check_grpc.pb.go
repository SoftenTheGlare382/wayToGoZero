...
func (c *checkerClient) Check(ctx context.Context, in *CheckReq, opts ...grpc.CallOption) (*Response, error) {
...
func (UnimplementedCheckerServer) Check(context.Context, *CheckReq) (*Response, error) {
...
func RegisterCheckerServer(s grpc.ServiceRegistrar, srv CheckerServer) {
	// If the following call panics, it indicates UnimplementedCheckerServer was
