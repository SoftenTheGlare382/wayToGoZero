...
const file_check_proto_rawDesc = "" +
	...
	"\bcheckReq\x12\x12\n" +
	"\x04book\x18\x01 \x01(\tR\x04book\"6\n" +
	"\bResponse\x12\x14\n" +
	"\x05found\x18\x01 \x01(\bR\x05found\x12\x14\n" +
	"\x05price\x18\x02 \x01(\x03R\x05price24\n" +
	"\achecker\x12)\n" +
	"\x05check\x12\x0f.check.checkReq\x1a\x0f.check.ResponseB\tZ\a./checkb\x06proto3"
...
var file_check_proto_depIdxs = []int32{
	...
	1, // 1: check.checker.check:output_type -> check.Response
